...
@Command(name = "Run PEA", mixinStandardHelpOptions = true, version = "PEARunner 1.0")
public class Default implements Runnable {
    private final static Logger LOGGER = Logger.getLogger(Default.class.getName());
    ...
    public static void main(String[] args) {
        CommandLine commandLine = new CommandLine(new Default());
    ...
    public void run() {
        ...
        World world = new World.Builder(image)
                ...
                .pictureFactory(computeMethod.newPicture(shapeCount, backgroundColor, shapeFactory))
                .build();
        world.setRandom();
        if(preview) {
